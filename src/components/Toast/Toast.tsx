...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      'fixed top-0 z-[100] flex w-full flex-col-reverse p-4 sm:flex-col md:max-w-[500px]',
      className
    )}
    {...props}
  />
