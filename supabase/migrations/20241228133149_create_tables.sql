...
create table "public"."assessments" (
    ...
    "session_name" character varying(255) default NULL::character varying,
    "notes" text,
...
alter table "public"."activities" add constraint "activities_created_by_fk" FOREIGN KEY (created_by) REFERENCES users(id) not valid;

alter table "public"."activities" validate constraint "activities_created_by_fk";

alter table "public"."activities" add constraint "activities_shift_id_fkey" FOREIGN KEY (shift_id) REFERENCES shifts(id) not valid;
...
alter table "public"."assessments" add constraint "assessments_parent_assessment_id_fkey" FOREIGN KEY (parent_assessment_id) REFERENCES assessments(id) not valid;

alter table "public"."assessments" validate constraint "assessments_parent_assessment_id_fkey";

alter table "public"."assessments" add constraint "assessments_student_id_fkey" FOREIGN KEY (student_id) REFERENCES students(id) not valid;

alter table "public"."assessments" validate constraint "assessments_student_id_fkey";

alter table "public"."assessments" add constraint "assessments_ustadz_id_fkey" FOREIGN KEY (ustadz_id) REFERENCES users(id) not valid;
...
alter table "public"."shifts" add constraint "shifts_ustadz_id_fk" FOREIGN KEY (ustadz_id) REFERENCES users(id) not valid;

alter table "public"."shifts" validate constraint "shifts_ustadz_id_fk";

alter table "public"."students" add constraint "students_circle_id_fkey" FOREIGN KEY (circle_id) REFERENCES circles(id) not valid;

alter table "public"."students" validate constraint "students_circle_id_fkey";

alter table "public"."students" add constraint "students_parent_id_fk" FOREIGN KEY (parent_id) REFERENCES users(id) not valid;
...
CREATE TRIGGER update_assessment_updated_at BEFORE UPDATE ON public.assessments FOR EACH ROW EXECUTE FUNCTION update_assessment_updated_at();
